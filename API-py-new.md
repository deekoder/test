...
- [Minio Golang Client SDK Quickstart Guide](http://docs.minio.io/docs/golang-client-quickstart-guide) 
- [Minio Java Client SDK Quickstart Guide](https://docs.minio.io/docs/java-client-quickstart-guide) 
- [Minio JavaScript Client SDK Quickstart Guide](https://www.docs.minio.io/docs/javascript-client-quickstart-guide)
